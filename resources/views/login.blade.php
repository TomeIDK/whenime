        ...
        <div class="hero-content flex-col gap-4 items-start">
            ...
            <div class="max-w-md">
                ...
                <label class="input input-bordered flex items-center gap-2">
                    ...
                    <input type="password" class="grow border-none focus:ring-transparent" placeholder="Password"
                        required />
                </label>

                <label class="label cursor-pointer flex flex-row justify-start gap-1">
                    <input type="checkbox" checked="checked" class="checkbox checkbox-xs rounded justify-start" />
