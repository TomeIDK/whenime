...
@section('content')
    <div class="mx-32 my-8">
        ...
        <h1 class="text-2xl font-bold px-12 pb-2">Top Airing Anime</h1>
                    ...
                    <div class="pl-4">
                        ...
                        @foreach ($anime['titles'] as $title)
                            @if ($title['type'] == 'English')
                                <a href="{{ $anime['url'] }}" class="hover:underline hover:text-primary">
        ...
        <h1 class="text-2xl font-bold px-12 pt-8 pb-2">Popular Upcoming Anime</h1>
