                ...
                <div class="max-w-md">
                    ...
                    <label class="input input-bordered flex items-center gap-2">
                        ...
                        <input type="text" name="username" class="grow border-none focus:ring-transparent"
                            placeholder="Username" value="{{ old('username') }}" required autofocus autocomplete="username" />
                    </label>
                    @error('username')
                    ...
                    <label class="input input-bordered flex items-center gap-2">
                        ...
                        <input type="date" name="date_of_birth" class="grow border-none focus:ring-transparent"
                    ...
                    <input type="file" name="profile_picture"
                        class="file-input file-input-sm file-input-bordered w-full max-w-xs border-none" />
